...
export const TeamPulseIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" {...props}>
    <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8zm-2-9.5h4v1.5h-4zm-2.5 3h9v1.5h-9zm2.5 3h4v1.5h-4z" />
    <path d="M12 7.5c-1.38 0-2.5 1.12-2.5 2.5s1.12 2.5 2.5 2.5 2.5-1.12 2.5-2.5-1.12-2.5-2.5-2.5z" opacity=".3"/>
  </svg>
);
...
export const PencilIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M16.862 4.487l1.687-1.688a1.875 1.875 0 112.652 2.652L10.582 19.5a2.25 2.25 0 01-1.06.602l-3 1 .9-2.822a2.25 2.25 0 01.602-1.06L15.362 5.687a2.25 2.25 0 012.652.602l.001.001zM14.25 7.5l2.25 2.25" />
    </svg>
);
...
export const InviteIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
...
export const LightBulbIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 18v-5.25m0 0a6.01 6.01 0 001.5-4.5 4.5 4.5 0 00-9 0 6.01 6.01 0 001.5 4.5m0 0l-1.151 1.151a1.5 1.5 0 00-1.06 2.44v1.658a1.5 1.5 0 001.5 1.5h6a1.5 1.5 0 001.5-1.5v-1.659a1.5 1.5 0 00-1.06-2.44L12 12.75z" />
    </svg>
);

export const SoccerBallIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" {...props}>
        <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm5.93 6.64l-3.6 2.1-1.32-3.96c1.85-.58 3.67-.1 4.92 1.86zm-8.53-3.96l-1.32 3.96-3.6-2.1c1.25-1.96 3.07-2.44 4.92-1.86zm-5.66 5.6l3.16 2.97-.72 4.11c-2.19-1.09-3.35-3.2-2.44-7.08zM12 18.6c-1.16 0-2.24-.23-3.24-.64l1.29-4.81h3.9l1.29 4.81c-1 .41-2.08.64-3.24.64zm4.74-3.46l-.72-4.11 3.16-2.97c.91 3.88-.25 5.99-2.44 7.08z" />
    </svg>
);
...
export const CardIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
     <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" {...props}>
        <path fillRule="evenodd" d="M4.5 3.75a3 3 0 00-3 3v10.5a3 3 0 003 3h15a3 3 0 003-3V6.75a3 3 0 00-3-3h-15zM6 8.25a.75.75 0 01.75.75v6a.75.75 0 01-1.5 0v-6a.75.75 0 01.75-.75zm12 0a.75.75 0 01.75.75v6a.75.75 0 01-1.5 0v-6a.75.75 0 01.75-.75z" clipRule="evenodd" />
    </svg>
);
